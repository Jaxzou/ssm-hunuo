						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">文章分类ID</th>
									<th class="center">添加时间</th>
									<th class="center">是否最新</th>
									<th class="center">是否推荐</th>
									<th class="center">是否所有人可访问</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.ARTCLE_KIND_ID}</td>
											<td class='center'>${var.ADD_TIME}</td>
											<td class='center'>
												<c:if test="${var.IS_NEW == 'on'}">
													<font color="blue">是</font>
												</c:if>
												<c:if test="${var.IS_NEW == 'off'}">
													<font color="red">否</font>
												</c:if>
											</td>
											<td class='center'>
												<c:if test="${var.IS_RECOMMEND == 'on'}">
													<font color="blue">是</font>
												</c:if>
												<c:if test="${var.IS_RECOMMEND == 'off'}">
													<font color="red">否</font>
												</c:if>
											</td>
											<td class='center'>
												<c:if test="${var.IS_USER == '1'}">
													<font color="blue">是</font>
												</c:if>
												<c:if test="${var.IS_USER == '2'}">
													<font color="red">否</font>
												</c:if>
											</td>
