package com.hunuo.controller.${packageName}.${objectNameLower};
...
import com.hunuo.controller.base.BaseController;
import com.hunuo.entity.Page;
...
import com.hunuo.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.hunuo.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
